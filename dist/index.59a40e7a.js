...
/** Interacción en detalle.html **/ const actorTerms = document.querySelectorAll(".actor-list dt");
...
/** Controles de vídeo personalizados en index.html **/ const video = document.getElementById("myVideo");
...
volumeBar.addEventListener("input", function() {
    ...
    if (volumeBar.value == 0) muteBtn.innerHTML = '<i class="fa-solid fa-volume-mute"></i>';
    else muteBtn.innerHTML = '<i class="fa-solid fa-volume-up"></i>';
});
